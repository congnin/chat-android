...
import com.congnin.chat.app.core.logout.LogoutContract;
import com.congnin.chat.app.core.logout.LogoutPresenter;
...
public class UserListActivity extends AppCompatActivity implements LogoutContract.View {
    ...
    private void init() {
        ...
        UsersListingPagerAdapter usersListingPagerAdapter = new UsersListingPagerAdapter(getSupportFragmentManager());
        mViewPagerUserListing.setAdapter(usersListingPagerAdapter);
